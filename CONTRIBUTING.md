...
Welcome to the contributor guide of RDF validation comparison.
...
If you experience bugs or general issues with RDF validation comparison, please have a look
...
You can help improve the documentation of RDF validation comparison by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/rdf-validation-comparison.git
   cd rdf-validation-comparison
   ```
